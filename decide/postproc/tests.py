...
#comprueba que las dos opciones mayoritarias obtienen 25 y 15 escaños cada una
    ...
    def test_bipartitanship6(self):
            ...
            expected_result = [
            { 'option': 'Option 1', 'number': 1, 'votes': 100000, 'postproc': 33 },
            { 'option': 'Option 3', 'number': 2, 'votes': 80000, 'postproc': 27 },
            { 'option': 'Option 4', 'number': 3, 'votes': 30000, 'postproc': 0 },
            { 'option': 'Option 2', 'number': 4, 'votes': 20000, 'postproc': 0 },
        ]    
